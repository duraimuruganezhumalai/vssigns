...
const Testimonials = () => {
    ...
    return (
        <React.Fragment>
            <section className="flex items-center justify-center pb-20 bg-white min-w-screen">
                    ...
                    <div className="container flex flex-col items-start mx-auto lg:items-center">
                        ...
                        <div className="items-center justify-center w-full mt-12 mb-4 lg:flex">
                            <div className="flex flex-col items-start justify-start w-full h-auto mb-12 lg:w-1/3 lg:mb-0">
                                ...
                                <blockquote className="mt-8 text-lg text-gray-500">"Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique, optio iste quam perferendis enim suscipit quos excepturi animi voluptatem totam adipisci vitae nam voluptatum. Suscipit obcaecati possimus est cum sit?
                                    "</blockquote>
                            </div>
                            <div className="flex flex-col items-start justify-start w-full h-auto px-0 mx-0 mb-12 border-l border-r border-transparent lg:w-1/3 lg:mb-0 lg:px-8 lg:mx-8 lg:border-gray-200">
                                ...
                                <blockquote className="mt-8 text-lg text-gray-500">"Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit sit culpa accusamus ut et eaque laudantium, dignissimos aperiam doloribus error aliquam pariatur voluptatem quidem, optio assumenda itaque quasi vitae harum."</blockquote>
                            </div>
                            <div className="flex flex-col items-start justify-start w-full h-auto lg:w-1/3">
                                ...
                                <blockquote className="mt-8 text-lg text-gray-500">"Lorem ipsum dolor sit amet, consectetur adipisicing elit. Architecto maiores consequatur iure quae necessitatibus eligendi ut laudantium ipsa aperiam tenetur ducimus nulla magni ad placeat quia dolores, magnam aliquid. Praesentium!"</blockquote>
                            </div>
                        </div>
                    </div>
                </div>
