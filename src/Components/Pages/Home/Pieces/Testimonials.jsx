...
const Testimonials = () => {
    ...
    return (
        <React.Fragment>
            <section className="flex items-center justify-center pb-20 bg-white">
                <div className="px-16 bg-white">
                    <div className="container flex flex-col items-start mx-auto lg:items-center min-w-screen-xl">
                        ...
                        <div className="max-w-screen-md mx-auto mb-8 text-center lg:mb-3">
                            <h2 className="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">See what others are saying</h2>
                        ...
                        <div className="items-center justify-center w-full mt-12 mb-4 lg:flex">
                            <div className="flex flex-col items-start justify-start w-full h-auto mb-12 lg:w-1/3 lg:mb-0">
                                ...
                                <blockquote className="mt-8 text-lg text-gray-500">"Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique cum sit?"</blockquote>
                            </div>
                            <div className="flex flex-col items-start justify-start w-full h-auto px-0 mx-0 mb-12 border-l border-r border-transparent lg:w-1/3 lg:mb-0 lg:px-8 lg:mx-8 lg:border-gray-200">
                                ...
                                <blockquote className="mt-8 text-lg text-gray-500">"Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit sit"</blockquote>
                            </div>
                            <div className="flex flex-col items-start justify-start w-full h-auto lg:w-1/3">
                                ...
                                <blockquote className="mt-8 text-lg text-gray-500">"Lorem ipsum dolor sit amet, consectetur adipisicing elit"</blockquote>
                            </div>
                        </div>
                    </div>
                </div>
