        ...
        <React.Fragment>
            ...
            {/* <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-col text-center w-full mb-20">
                        ...
                        <p className="py-6 leading-relaxed">Lorem ipsum dolor sit, amet consectetur fdgsfdgfdsg fdsgsdgs  adipisicing elit. Amet, sdfgsfdgf obcaecati, laudantium sit consequuntur ex illo, exercitationem ad numquam voluptatem nostrum molestias alias adipisci rerum natus similique cumque quod architecto vel? Copper mug try-hard pitchfork pour-over freegan heirloom neutra air plant cold-pressed tacos poke beard tote bag. Heirloom echo park mlkshk tote bag selvage hot chicken authentic tumeric truffaut hexagon try-hard chambray.</p>
                    </div>
                </div> */}
                ...
                <div className="max-w-screen-xl px-4 py-8 mx-auto lg:px-6">
                    <div className="mx-auto mb-8 text-center lg:mb-12">
                        ...
                        <p className="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">
                            SV Signs offers competitive pricing without compromising quality and selection that is second to none, and willingness to help that cannot be surpassed. SV Signs offers a unique capability within our region to manufacture and install all projects without subcontractors.
                            SV Signs is the name preferred by most of the leading Architects, Engineers, Graphic designers, Interior designers, Corporates & Leading Businessmen. We are proudly committed to our leadership role as the most innovative, technically advanced and real manufacturer in Tamilnadu. We Provide customer satisfaction, through the superior quality of our various product range and services, remain the foundation of our success.
                        </p>
                    </div>
                </div>
            </section>
