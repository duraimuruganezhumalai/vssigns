...
class Contactus extends Component {
    ...
    handleonSubmit = (e) => {
        ...
        const isFormvalid = this.validationFields()
    ...
    validationFields() {
        ...
        if (!message) {
            errors['message'] = 'please enter your msg'
        }
    ...
    render() {
        ...
        const { name: nameError, email: emailError, phone: phoneError, message: messageError } = this.state.validationErrors;
